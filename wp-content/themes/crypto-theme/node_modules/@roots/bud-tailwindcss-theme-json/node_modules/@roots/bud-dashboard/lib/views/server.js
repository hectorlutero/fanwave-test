...
export const Server = ({ devUrl, displayServerInfo, mode, proxy = false, proxyUrl, publicDevUrl, publicProxyUrl, }) => {
    if (!displayServerInfo ||
        ...
        return null;
    return (_jsxs(Box, { flexDirection: "column", children: [_jsx(Text, { children: ` ` }), _jsx(Text, { color: "blue", children: "Network" }), _jsx(Text, { children: ` ` }), _jsx(Proxy, { proxy: proxy, proxyUrl: proxyUrl, publicProxyUrl: publicProxyUrl }), _jsx(Dev, { devUrl: devUrl, publicDevUrl: publicDevUrl })] }));
};
