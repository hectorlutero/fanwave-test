...
export default class BudViewCommand extends BudCommand {
    ...
    async execute() {
        ...
        BudViewCommand.renderStatic(_jsxs(Box, { flexDirection: "column", children: [_jsx(Text, { color: "magenta", children: this.subject ?? `build.config` }), _jsx(Text, { children: ` ` }), _jsx(Text, { children: value })] }));
    }
}
