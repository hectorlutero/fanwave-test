...
export declare class HtmlEmitter {
     ...
     */
    entrypointsReducer(acc: string, [type, files]: [string, Set<string>]): string;
    /**
     ...
     */
    makeScript(attributes: Record<string, boolean | string>, inner?: null | string): string | undefined;
    /**
