...
export interface Cache {
    ...
    setAllowCollectingMemory(value: CacheCallback<FileCacheOptions[`allowCollectingMemory`]>): this;
    /**
     * Set build dependencies
     */
    setBuildDependencies(value: CacheCallback<FileCacheOptions[`buildDependencies`]>): this;
    /**
     * Set cache directory
     */
    setCacheDirectory(value: CacheCallback<FileCacheOptions[`cacheDirectory`]>): this;
    /**
     * Set cache type
     */
