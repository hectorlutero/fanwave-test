...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        sortTable: function(key) {
            if (this.sortKey === key) {
                this.sortOrder *= -1; // Change the sort order if the same key is clicked again
            } else {
                this.sortKey = key;
                this.sortOrder = 1; // Default to ascending order for a new key
            }
            this.coins.sort((a, b)=>{
                const aValue = a[key];
                const bValue = b[key];
                // Use localeCompare for case-insensitive string sorting
                    ...
                    (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", _hoisted_7, [
                        (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [
                            ...
                            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
                                scope: "col",
                                class: "py-3 px-6",
                                onClick: _cache[8] || (_cache[8] = ($event)=>$options.sortTable('currentPrice'))
                            }, " Current Price "),
                            (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
                                scope: "col",
                                class: "py-3 px-6",
                                onClick: _cache[9] || (_cache[9] = ($event)=>$options.sortTable('marketCap'))
                            }, " Market Cap ")
                        ])
                    ]),
...
//# sourceMappingURL=app.921fc3ddc338bbab.hot-update.js.map