    ...
    methods: {
        ...
        logUserInput: function() {
            const filteredCoins = this.coins.filter((coin)=>{
                return coin.name.toLowerCase().includes(this.userInput.toLowerCase());
            });
            console.log(filteredCoins);
            if (this.userInput && filteredCoins.length > 1) {
...
//# sourceMappingURL=app.df3d771beb398267.hot-update.js.map