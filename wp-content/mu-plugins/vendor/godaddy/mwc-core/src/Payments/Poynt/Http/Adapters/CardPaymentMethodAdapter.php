...
class CardPaymentMethodAdapter implements DataSourceAdapterContract
{
    ...
    public function convertToSource(Response $response = null) : CardPaymentMethod
    {
        ...
        $this->checkAvsResponse($responseBody);
     ...
     * @throws InvalidTransactionException
     */
    protected function checkAvsResponse(array $responseBody) : void
    {
        ...
        if (in_array('NO_MATCH', [$addressResult, $postalCodeResult])) {
            throw new InvalidTransactionException('AVS has a NO_MATCH result');
        }
    }
}
