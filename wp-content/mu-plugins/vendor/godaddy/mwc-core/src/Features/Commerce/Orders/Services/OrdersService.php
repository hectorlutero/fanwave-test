...
class OrdersService implements OrdersServiceContract
{
    ...
    public function listOrdersById(ListOrdersByIdOperationContract $operation) : ListOrdersResponseContract
    {
        ...
        $output = $this->listOrdersByIdInRemoteService($this->getRemoteIdsFromLocalIds($localIds));
    ...
    {
        // TODO: implement this method in MWC-13809
        return OrdersListOutput::getNewInstance();
    }
}
